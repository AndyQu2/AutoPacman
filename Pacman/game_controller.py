...
class GameController(object):
    ...
    def startGame(self):
        ...
        self.mazesprites = MazeSprites("Pacman/resources/" + self.mazedata.obj.name + ".txt",
                                       "Pacman/resources/" + self.mazedata.obj.name + "_rotation.txt")
        self.setBackground()
    ...
    def startGame_old(self):
        ...
        self.setBackground()
        self.nodes = NodeGroup("resources/maze1.txt")
        self.nodes.setPortalPair((0, 17), (27, 17))
        homekey = self.nodes.createHomeNodes(11.5, 14)
        self.nodes.connectHomeNodes(homekey, (12, 14), LEFT)
        self.nodes.connectHomeNodes(homekey, (15, 14), RIGHT)
        self.pacman = Pacman(self.nodes.getNodeFromTiles(15, 26))
        self.pellets = PelletGroup("resources/maze1.txt")
        self.ghosts = GhostGroup(self.nodes.getStartTempNode(), self.pacman)
    ...
    def update_manually(self, direction):
        dt = self.clock.tick(30) / 1000.0
        self.textgroup.update(dt)
        self.pellets.update(dt)
        if not self.pause.paused:
        ...
        if self.pacman.alive:
            if not self.pause.paused:
                self.pacman.update_manually(dt, direction)
        else:
            self.pacman.update_manually(dt, direction)
